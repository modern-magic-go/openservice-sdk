...
// AccessToken 获取 OpenService 缓存的小程序 access token。
func (m *MiniProgram) AccessToken(ctx context.Context) (*AccessTokenData, error) {
	...
	return getWechatAccessToken(ctx, m.client)
}
